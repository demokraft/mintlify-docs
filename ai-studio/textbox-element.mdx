...
A character-level split animation (Drop/Slide/Ascend/Scale/Typewriter with Split By = Character, Coded, or Decode), will be downgraded to Word-level splitting.
</Note>
